...
for i in range(0, 6):
    ...
    if result.json()['result'] == 'success':
        ...
        log.write(result.json()['errorMsg'] + '\n')
        # print u'预约成功'
    else:
        log.write('预约出错: ')
        print u'预约失败'
