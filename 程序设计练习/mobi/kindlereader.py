...
<docTitle><text>豆瓣影评</text></docTitle>
<docAuthor><text>豆瓣影评</text></docAuthor>
<navMap>
    {% if format == 'periodical' %}
    <navPoint class="periodical">
        <navLabel><text>豆瓣影评</text></navLabel>
...
<dc-metadata xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:opf="http://www.idpf.org/2007/opf">
    {% if format == 'periodical' %}
    <dc:title>豆瓣影评</dc:title>
    {% else %}
    <dc:title>豆瓣影评({{ mobitime.strftime("%m/%d %H:%M") }})</dc:title>
    {% end %}
    <dc:language>zh-CN</dc:language>
    <dc:identifier id="uid">豆瓣影评</dc:identifier>
    <dc:creator>kindlereader</dc:creator>
    <dc:publisher>kindlereader</dc:publisher>
    <dc:subject>豆瓣影评</dc:subject>
